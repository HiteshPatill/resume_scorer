...
import { Code2, Share2, Mail, Zap } from 'lucide-react';
    ...
    <footer className="border-t border-border/50 bg-card/50 backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-lg">ResumeScore</h3>
            </div>
            <p className="text-sm text-muted-foreground">
              Know exactly where you stand before you apply. AI-powered ATS resume analysis.
            </p>
          </div>
        ...
        <div className="border-t border-border/30 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {currentYear} ResumeScore. All rights reserved.
          </p>
